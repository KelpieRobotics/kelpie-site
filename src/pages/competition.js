        ...
        <div>
            ...
            <TemplatePage title="Competition">
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <iframe width="750" height="422" src="https://www.youtube.com/embed/kkrhp5KH51c" frameborder="0" allowfullscreen style={{ maxWidth: '750px', width: '100%', borderRadius: '25px' }}></iframe>
                </div>
                <br />
            </TemplatePage>
        </div>
