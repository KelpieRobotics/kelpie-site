          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-8">
                ...
                >
                  <h2 className="text-xl font-bold mb-4 text-gray-800 font-tetra">
                    Follow Us
                  </h2>
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 text-gray-600">
                    ...
                    <button
                      className="mt-2 bg-teal-600 hover:bg-teal-700 text-white font- py-2 px-6 rounded-lg transition-colors w-fit font-tetra"
