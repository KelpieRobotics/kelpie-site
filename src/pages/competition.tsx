...
function CompetitionSection({ title, description, flip = false , otherside}) {
  return (
    ...
    <div>
      ...
      <section className="relative flex flex-col justify-center text-left text-white overflow-hidden" style={{ height: '50vh', width: '100%' }}>
        ...
        <div
          ...
          style={{ backgroundImage: "url('/assets/branding/Copy of wide pool.jpg')", backgroundSize: 'cover', backgroundPosition: '25% 50%'}}
        />
        <div
          className="absolute inset-0"
          style={{
      ...
      <div>
        <div className="bg-white p-5">
          <CompetitionSection
            ...
            <Link href="https://materovcompetition.org/" target="_blank" rel="noopener noreferrer">
              <Image
          ...
          <CompetitionSection
            ...
            flip={true}
            otherside= {
              <svg width="180" height="280" viewBox="0 0 80 140" fill="none" opacity="0.3">
          ...
          <CompetitionSection
            ...
            otherside={ 
              <svg className="opacity-15" width="130" height="200" viewBox="0 0 130 200" fill="none">
                {/* Big jellyfish */}
