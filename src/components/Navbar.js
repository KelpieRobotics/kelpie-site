...
function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-gray-900 text-white" style={{ position: 'sticky', top: 0, zIndex:100 }}>
      <Link href="/">
          ...
          <div className="fixed top-0 left-0 right-0 bottom-0 bg-gray-900 text-white z-50">
            <div className="flex flex-col p-4 space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Image
                  src="/assets/branding/kelpii.svg"
